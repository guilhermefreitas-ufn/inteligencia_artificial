...
class Perceptron:
	...
	def teste(self, amostra):
		...
		if saida_gerada == 1:
			print('Classe: %d. Aprovado' % saida_gerada)
		else:
			print('Classe: %d. Recusado' % saida_gerada)
...
while (True):
	...
	x = float(input('Valor normalizado para histórico de crédito: '))
	y = float(input('Valor normalizado para renda mensal: '))
	print('Ponto: ', x , ' , ', y)
	rede.teste([x,y])
