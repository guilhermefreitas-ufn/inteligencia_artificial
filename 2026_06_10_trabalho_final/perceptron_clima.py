...
class Perceptron:
	...
	def teste(self, amostra):
		...
		if saida_gerada == 1:
			print('Classe: %d. Chove' % saida_gerada)
		else:
			print('Classe: %d. Não Chove' % saida_gerada)
...
amostras = [[0.20, 0.90],  # Ar seco, pressão alta -> Sol
...
while (True):
	...
	x = float(input('Valor normalizado para umidade: '))
	y = float(input('Valor normalizado para pressão: '))
	print('Ponto: ', x , ' , ', y)
	rede.teste([x,y])
